...
<html lang="en" class="ms-5 me-5">
    ...
    <nav class="navbar navbar-expand-lg bg-primary bg-gradient">
        ...
        <a href="golongan/create" class="btn btn-dark mb-2 float-end">Tambah Golongan</a>
                ...
                <tr class="table-primary text-center">
                    ...
                    @foreach ($rows as $row)
                        <tr>
                            ...
                            <td class="text-center" style="width:50px;"><a href="golongan/edit/{{ $row->id }}" class="badge text-bg-success text-decoration-none">Edit</a></td>
                            <td class="text-center" style="width:50px;"><a href="golongan/destroy/{{ $row->id }}" class="badge text-bg-danger text-decoration-none" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');">Hapus</a></td>
                        </tr>
                    @endforeach
            </table>
        </div>
