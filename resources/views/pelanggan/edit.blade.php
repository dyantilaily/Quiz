            ...
            <form action="store" method="post" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('pel_nama')
                        is-invalid
                    @enderror" placeholder="Nama Pelanggan" name="pel_nama" value="{{ $pelanggan->pel_nama }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">NIK KTP</label>
                    <input type="text" class="form-control @error('pel_ktp')
                        is-invalid
                    @enderror" placeholder="NIK KTP" name="pel_ktp" value="{{ $pelanggan->pel_ktp; }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Alamat</label>
                    <input type="text" class="form-control" placeholder="Alamat" name="pel_alamat" value="{{ $pelanggan->pel_alamat; }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Handphone</label>
                    <input type="text" class="form-control" placeholder="Handphone" name="pel_hp" value="{{ $pelanggan->pel_hp; }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Nomor Pelanggan</label>
                    <input type="text" class="form-control" placeholder="Nomor Pelanggan" name="pel_no" value="{{ $pelanggan->pel_no; }}" disabled>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Golongan</label>
                    <select class="form-select" name="pel_id_gol">
                        @foreach ($golongans as $gol_nama)
                            <option value="{{ $pelanggan->pel_id_gol; }}">{{ $gol_nama->gol_nama; }}</option>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Seri Pelanggan" name="pel_seri" value="{{ $pelanggan->pel_seri; }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Aktif</label>
                    <select class="form-select" name="pel_aktif">
                        <option value="{{ $pelanggan->pel_aktif }}">{{ $pelanggan->pel_aktif }}</option>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Nomor Meteran" name="pel_meteran" value="{{ $pelanggan->pel_meteran }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">User</label>
                    <select class="form-select" name="pel_id_user">
                        @foreach ($users as $user_nama)
                            <option selected value="{{ $pelanggan->pel_id_user }}">{{ $user_nama->user_nama }}</option>
                            <option value="{{ $user_nama->id }}">{{ $user_nama->user_nama }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-12">
                    <button type="submit" class="btn btn-primary" name="btn_tambah">Edit</button>
                </div>
            </form>
        </div>
